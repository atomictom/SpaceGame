...
(function() {
  var KEY, canvas, canvas2, counter, ctx, fps, game_ctx, gameloop, init, keydown, keys, keyup, last_turn, max_frame_time, paused, print, render_interval, running, ship, time_accumulator, total_time, updateLogic, updateScreen, update_interval, ups;
  ...
  updateScreen = function() {
    ...
    ctx.rotate(-(ship.r - Math.PI / 2));
    ctx.translate(-ship.x, -ship.y);
    return game_ctx.drawImage(canvas2, 0, 0);
  };
